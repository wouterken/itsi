...
Gem::Specification.new do |spec|
  ...
  spec.metadata['source_code_uri'] = 'https://github.com/woutercoppieters/itsi'
  spec.metadata['changelog_uri'] = 'https://github.com/woutercoppieters/itsi/blob/main/CHANGELOG.md'
  ...
  spec.add_dependency 'itsi-scheduler', '~> 0.1.14'
  spec.add_dependency 'itsi-server', '~> 0.1.14'
